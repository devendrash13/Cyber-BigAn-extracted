...
<div style="color:red;font-size:50px;font-weight:bold;text-align: center;padding-top:50px;padding-bottom:20px;"  > Welcome In Our Social Media </div>
...
<div>
 ...
 <br> <img  src="<?= $row['avatar'] ?>" style="width:80px;height:100px;" align="middle"><br />
    ...
    <div id='registered'>
    <span style="padding-left:20px">Now Your Are A Registered User.</span>
